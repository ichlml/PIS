...
@section('header')
    ...
    @section('content')
        <h2 class="section-title">Form Tambah Data Kendaraan</h2>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_kendaraan"
                                            ...
                                            value="{{ old('nama_kendaraan') }}" placeholder="masukan nama kendaraan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nopol"
                                            ...
                                            value="{{ old('nopol') }}" placeholder="masukan no polisi kendaraan"
                                            autocomplete="off" autofocus>
                                        @error('nopol')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="warna"
                                            ...
                                            value="{{ old('warna') }}" placeholder="masukan warna kendaraan"
                                            autocomplete="off" autofocus>
                                        @error('warna')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="merk"
                                            ...
                                            value="{{ old('merk') }}" placeholder="masukan merk kendaraan"
                                            autocomplete="off" autofocus>
                                        @error('merk')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kelas" class="form-control @error('kelas') is-invalid @enderror">
                                            ...
                                            <option value="A" {{ old('kelas') == 'A' ? 'selected' : null }}>
                                                A</option>
                                            <option value="B" {{ old('kelas') == 'B' ? 'selected' : null }}>
                                                B</option>
                                            <option value="C" {{ old('kelas') == 'C' ? 'selected' : null }}>
                                                C</option>
                                        </select>
                                        @error('kelas')
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jenis"
                                            ...
                                            value="{{ old('jenis') }}" placeholder="masukan Jenis Kendaraan"
                                            autocomplete="off" autofocus>
                                        @error('jenis')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_bbm"
                                            ...
                                            <option value="PERTAMAX/PERTALITE"
                                                {{ old('jenis_bbm') == 'PERTAMAX/PERTALITE' ? 'selected' : null }}>
                                                PERTAMAX/PERTALITE</option>
                                            <option value="BIOSOLAR/DEXLITE"
                                                {{ old('jenis_bbm') == 'BIOSOLAR/DEXLITE' ? 'selected' : null }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="transmisi"
                                            ...
                                            <option value="">-- pilih --</option>
                                            <option value="Manual" {{ old('transmisi') == 'Manual' ? 'selected' : null }}>
                                                Manual</option>
                                            <option value="Otomatis"
                                                {{ old('transmisi') == 'Otomatis' ? 'selected' : null }}>
                                                Otomatis</option>
                                        </select>
                                        @error('departemen')
                                            <div class="invalid-feedback">
